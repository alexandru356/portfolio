    ...
    return (
        <>
            ...
            <div className="who-card">
                <h1 className='header'> <img src={user} className='userIcon' alt="" /> About</h1>
                <p className="text">
                    Hey! I'm Alexandru Ciuca, a passionate student from <span className='mtl'>Montreal</span>  currently looking for internship opportunities
                    to enhance my skills and become a better developer. I'm eager to work on new projects and learn along the way.
                    Feel free to reach out to me !
                </p>
            </div>

            <div className="tech-card">
                <h1 className="header"> <img src={tools} alt="Tool box" className='techicon' />Tech Stack</h1>
            ...
            <div className="edu-card">
                <h1 className="header"> <img src={diploma} className='userIcon' alt="" /> Education</h1>
